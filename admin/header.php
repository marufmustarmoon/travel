...
<nav class="navbar navbar-expand-lg navbar-light bg-dark ">
  <a class="navbar-brand text-light" href="index.php"><h2>Dashboard Of Admin</h2></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <li class="nav-item active">
        <a class="nav-link text-light" href="booked.php">Booked List <span class="sr-only">(current)</span></a>
      </li>
<?php
